...
- Use a trusted password manager, OS keychain, or a local secure-input workflow that writes directly to an owner-only destination.
...
- If a secret appears in an unsafe channel, treat it as exposed and rotate it.
